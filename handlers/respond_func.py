...
from handlers.func_modules.managers import manager
from handlers.func_modules.administration_module import Administration
from handlers.func_modules.cabal_module import Cabal
from handlers.func_modules.funny_module import Funny
from handlers.func_modules.info_module import Info
from vkbottle.bot import Message , BotLabeler



######################################################################################################
class Respondent_command(ExtendParams,String_parse,NameBuilder,Administration,Funny,Info,Cabal,manager):
